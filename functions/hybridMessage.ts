...
[END GROUNDING]`;
        ...
        CRITICAL VIDEO EMBEDDING RULE: When sharing YouTube, Vimeo, or other video links, ALWAYS provide ONLY the raw URL on its own line. NO markdown brackets, NO text labels, NO "YouTube:" prefix. Just the bare URL. The UI will auto-embed videos when it sees raw URLs.
        Example: https://youtu.be/abc123 (NOT [YouTube: https://youtu.be/abc123])${profileContext}${identityContract}${dateContext}${groundingRules}`;
