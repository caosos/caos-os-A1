          ...
          <Section title="⚠️ KERNELIZED AGENT RECOVERY HEADER (READ FIRST IF YOU ARE A FRESH AGENT)" color="yellow">
            ...
            <div className="space-y-3">
              <div className="bg-yellow-950/40 border border-yellow-500/20 rounded-lg p-4 text-gray-200 text-xs space-y-2">
                ...
                <p><strong>6) Last TSB Entry:</strong> TSB-048 (Mar 15, 2026) — in TSBLog Part 2 (/TSBLog2). See also: TSB-043 micro-index, TSB-044 watchdog+retry, TSB-045 dev guard, TSB-046 always-on button, TSB-047 WCW telemetry, TSB-048 dual-TTS formalization.</p>
