...
Wait for the owner to tell you what they need.`}</pre>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-xs mt-1">Last Updated: Mar 13, 2026 · GOV v1.2 Amendment A: Anti-Bloat Extraction Rule ACTIVE ✅ · Stabilization Phase: IN PROGRESS 🔧 · Zero-error target: 4xx/5xx elimination underway · ODEL v1: PHASE 1.4 COMPLETE ✅ · RSoD: ACTIVE ✅ (TSB-024) · errorClassifier: DEPLOYED ✅ · Phase A Memory: LOCKED ✅ · Heuristics Engine v1: LOCKED ✅ · TTS (OpenAI + Google): LOCKED ✅ · WCW Meter: FIXED ✅ · Runtime Authority: CENTRALIZED ✅ · Web Search: IMPLEMENTED ✅ · Active Model: gpt-5.2 (200K) ✅ · Chat.jsx Refactor: IN PROGRESS 🔧 (~1126 lines remaining) · CTC Phase 1–3: WIRED ✅ · PR1 COMPLETE ✅ (TSB-025) · PR2 COMPLETE ✅ (TSB-027/TSB-028) — ChatBubble ≤400 lines, all bubble/ sub-components extracted · MBCR v1 DEPLOYED ✅ (TSB-028) · TRH v1 DEPLOYED ✅ (TSB-029) · metadata_tags ACTIVE ✅ · UI LAG FIXED ✅ (TSB-030/031) — DISPLAY_LIMIT=50, ChatBubble memoized, ChatInput state isolated · hybridMessage: 925 lines ⚠️ OVER LIMIT — FROZEN (TSB-021/TSB-032) · Phase 0 Observability: LIVE ✅ · generalInference P0 Timeout Patch: LIVE ✅ (TSB-033) · FunctionManifest Governance Purge: COMPLETE ✅ (TSB-034) · runtimeRegistry actor: SERVER-ENFORCED ✅ · Emoji Legend: LIVE ✅ (TSB-035) · SSE Streaming: SHIPPED/DISABLED (TSB-036, ENABLE_STREAMING=false) · TTS Emoji Strip: COMPLETE ✅ (TSB-037) · TTS Unification v1: CLOSED ✅ (TSB-039) — 3 canonical .jsx files, tts/ directory deleted, all imports extensionless</p>
...
4. Tune reasoning prompt for emotional interpretation`}</Code>
          ...
          <Section title="15. TSB Log — Troubleshooting Bulletins" color="red">
            ...
            <Link to={createPageUrl('TSBLog')} className="inline-block text-blue-300 hover:text-blue-100 underline font-semibold">
              → View Full TSB Log (TSB-001 through TSB-039)
            </Link>
