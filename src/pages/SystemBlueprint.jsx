...
Wait for the owner to tell you what they need.`}</pre>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-xs mt-1">Last Updated: Mar 7, 2026 · ODEL v1: PHASE 1.4 COMPLETE ✅ · RSoD (Red Screen of Death): ACTIVE ✅ (TSB-024) · errorClassifier: DEPLOYED ✅ (components/lib/errorClassifier.jsx) · Phase A Memory: LOCKED ✅ · Heuristics Engine v1: LOCKED ✅ (INLINED into hybridMessage) · TTS (OpenAI + Google): LOCKED ✅ · WCW Meter: FIXED ✅ · Runtime Authority: CENTRALIZED ✅ · Web Search: IMPLEMENTED ✅ · Artifact Loader: IMPLEMENTED ✅ · External Knowledge Detector: v2 BROWSE-ON-VERB ✅ · SelectorEngine: v2 BROWSE-ON-VERB ✅ · UserStorage Entity: ADDED ✅ · UserFile Entity: ACTIVE (files/photos/links) ✅ · Files/Photos/Links Panel: FIXED ✅ · File Storage Architecture: DOCUMENTED ✅ · Platform Constraints: DOCUMENTED ✅ · Module Catalogue: ADDED ✅ · Agent Onboarding Contract: ADDED ✅ · hybridMessage: LOCKED ✅ (v2 — 538 lines, refactor pending) · textToSpeech: LOCKED ✅ · transcribeAudio: LOCKED ✅ · Authority Domain Separation: LOCKED ✅ · Pull-Only Awareness Rule: LOCKED ✅ · Active Model: gpt-5.2 (200K token limit) ✅ · Chat.jsx Refactor: IN PROGRESS 🔧 (useAuthBootstrap ✅ · useConversations ✅ · ~1126 lines remaining) · Edit Tracking Convention: ACTIVE ✅ · CTC Phase 1: DEPLOYED ✅ (ThreadIndex + ContextSeed + LaneState + LaneSeedHistory + threadIndexLoader) · CTC Phase 2: DEPLOYED ✅ (crossThreadIntent + threadHydrator + sanitizer) · CTC Phase 3: WIRED ✅ (seedCompressor + arcAssembler + hybridMessage CTC stages LIVE) · Governance Gates: DESIGNED ✅ (Mar 5, 2026 — Lock Manifest + CI gate architecture documented) · receiptWriter: FIRE-AND-FORGET ⚠️ (TSB-021 — I2 invariant violated) · BIOLOGICAL REALITY POLICY: ACTIVE in promptBuilder ✅ · PR1 COMPLETE ✅ (Mar 7, 2026 — ChatBubble refactored into bubble/ sub-components — TSB-025) · PR2 IN PROGRESS 🔧 (Mar 7, 2026 — ChatBubble modularization to ≤400 lines — TSB-027)</p>
...
4. Tune reasoning prompt for emotional interpretation`}</Code>
          ...
          <Section title="14. TSB Log — Troubleshooting Bulletins" color="red">
            ...
            <Link to={createPageUrl('TSBLog')} className="inline-block text-blue-300 hover:text-blue-100 underline font-semibold">
              → View Full TSB Log (TSB-001 through TSB-027)
            </Link>
