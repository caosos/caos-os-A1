...
export default function ChatInput({ onSend, isLoading, lastAssistantMessage, onTypingStart, multiAgentMode, conversationId, messageValue = '', onMessageChange }) {
  ...
  // toggleReadAloud is handled by toggleGoogleReadAloud from ChatInputReadAloud (no API, pure Web Speech API)
  ...
  // Agent selection state owned here so selectedAgents flows into onSend
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto px-4 py-2">
      ...
      <AgentSelector multiAgentMode={multiAgentMode} onSelectionChange={setSelectedAgents} />
